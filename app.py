...
# --- Input Features ---
st.markdown('<h4 style="color:#4682B4; display: inline;">Enter Network Traffic Features</h4> <span style="color:#4682B4;">[Adjust the sliders below for each feature and press "Predict Instrusion" button to generate the prediction]</span>', unsafe_allow_html=True)
