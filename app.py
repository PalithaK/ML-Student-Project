...
# --- Input Features ---
st.markdown('<h2 style="color: #ADD8E6; margin-bottom: 0px;">Enter Network Traffic Features</h2>', unsafe_allow_html=True)
st.markdown('<p style="color: #4682B4; margin-top: 0px;">Adjust the sliders below for each feature to generate a prediction:</p>', unsafe_allow_html=True)
