...
st.markdown('<h4 style="color: #FF7F7F; margin-bottom: 0px;">Enter Network Traffic Features ' st.markdown('<p  margin-top: 0px;">Adjust the sliders below for each feature then generate a prediction:</p>', unsafe_allow_html=True) ' </h2>', unsafe_allow_html=True)
